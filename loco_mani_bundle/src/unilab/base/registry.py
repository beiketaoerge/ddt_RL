...
# Bundle trim: this loco-mani bundle only ships unilab.envs.locomotion (go2_arm).
# Upstream also scans unilab.envs.manipulation and unilab.envs.motion_tracking.
